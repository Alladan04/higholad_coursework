...
Кроме этого стоит установить ЦОДы в следующих географических точках:
- Альберта, Канада
- Богота, Колумбия
...
Суммарно имеем 11 ЦОДов на 20 млн DAU.
...
Для балансировки нагрузки по регионам будем использовать  GeoDNS, чтобы каждый клиент обслуживался тем ЦОД, который находится к нему 
ближе географически.
