...
### Таблица расчетов ресурсов для баз данных

| **База данных**    | **Объем данных** | **Целевая пиковая нагрузка (QPS)** | **CPU (ядра)** | **RAM** | **Диск (ТБ)** | **Net (Гбит/с)** |
|---------------------|------------------|------------------------------------|----------------|---------|---------------|------------------|
| **PostgreSQL**      | 1.4 ТБ          | 48,360                             | 150            | 600 ГБ  | 3 ТБ          | 6              |
| **MongoDB**         | 4.8 ТБ          | 15,350                             | 100            | 800 ГБ  | 5 ТБ          | 3              |
| **Elasticsearch**   | 4.8 ТБ          | 11,860                             | 120            | 700 ГБ  | 6 ТБ          | 4              |
| **ClickHouse**      | 26.6 ТБ         | 31,000                             | 200            | 1.2 ТБ  | 30 ТБ         | 6              |
